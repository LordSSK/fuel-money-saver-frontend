  ...
  Widget build(BuildContext context) {
    return  Container(
      child: Column(children: [
        TextField(controller: _currentFuel,onChanged: onCurrentFuelChanged,keyboardType: TextInputType.number,decoration: InputDecoration(hintText: "Current Fuel"),),
        TextField(controller: _fuelCapacity,onChanged: onCapacityChanged,keyboardType: TextInputType.number,decoration: InputDecoration(hintText: "Capacity"),),
        TextField(controller: _mileage,onChanged: onMileageChanged,keyboardType: TextInputType.number,decoration: InputDecoration(hintText: "Mileage"),)
      ],),
    );
  }
